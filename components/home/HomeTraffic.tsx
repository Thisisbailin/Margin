...
const HomeTraffic: React.FC<HomeTrafficProps> = ({
  userId,
  projectId,
  isActive = true,
  showClose = false,
  ...
  return (
    <div className={`flex-1 flex flex-col overflow-hidden animate-fade-in ${className || ''}`.trim()}>
      <div className={`flex-1 h-full w-full rounded-[3rem] border border-black/5 bg-white/60 shadow-soft overflow-hidden ${panelClassName || ''}`.trim()}>
        <div className="h-full flex flex-col gap-8 p-6 md:p-8 overflow-hidden">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="font-display text-3xl text-ink italic">Traffic</h2>
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-6 overflow-hidden">
